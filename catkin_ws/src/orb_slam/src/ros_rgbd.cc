...
int main(int argc, char **argv)
{
    ...
    if(argc < 3 || argc > 5)
    {
        cerr << endl << "Usage: rosrun ORB_SLAM3 RGBD path_to_vocabulary path_to_settings [rgb_topic] [depth_topic]" << endl;        
        ros::shutdown();
        return 1;
    }    
    ...
    string depth_topic = "/camera/depth_registered/image_raw";
